...
class User(Base):
    ...
    role = Column(String(50), default="recruteur")   # recruteur
...
class Offre(Base):
    ...
    localisation = Column(String(100), default="Fès, Maroc (Hybride)")
    salaire_estime = Column(String(100), default="Selon profil")
